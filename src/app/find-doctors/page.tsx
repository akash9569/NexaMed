...
import { Stethoscope, UserMd, MapPin, Search, CheckCircle } from 'lucide-react';
        ...
        <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogTitle className="text-center">Appointment Confirmed!</AlertDialogTitle>
              <AlertDialogDescription className="text-center">
                Your appointment with <strong>{selectedDoctor.name}</strong> has been successfully booked. You will receive a confirmation email shortly.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogAction onClick={() => setIsDialogOpen(false)} className="w-full">
                Done
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
